...
void  KaiKhorusAudioProcessor::ReadFromDelayBuffer(int channel, int delayBufferSize, int bufferSize, juce::AudioBuffer<float>& buffer, juce::AudioBuffer<float>& delayBuffer)
{
